...
namespace UnityEditor.Tilemaps
{
    ...
    public class TestBrush : GridBrushBase
    {
        ...
        {
            if (ValidateCellPosition(position))
                m_Cells[GetCellIndex(position)].orientation = Quaternion.identity;
    ...
    public class TestBrushEditor : GridBrushEditorBase
    {
        ...
        /// </summary>
        public TestBrush brush => target as TestBrush;
        ...
        public override Texture2D RenderStaticPreview(string assetPath, Object[] subAssets, int width, int height)
        {
            ...
            GameObject previewInstance = new GameObject("Brush Preview", typeof(Grid));
